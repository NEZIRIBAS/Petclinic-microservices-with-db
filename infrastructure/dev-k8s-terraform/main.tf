...
resource "aws_iam_instance_profile" "petclinic-master-server-profile-new" {
...
resource "aws_instance" "kube-master" {
  ...
  iam_instance_profile = aws_iam_instance_profile.petclinic-master-server-profile-new.name
